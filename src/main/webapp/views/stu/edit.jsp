...
<body>
    <div class="main">
        ...
        <form:form action="${pageContext.request.contextPath }/stu/edit" modelAttribute="student">
        <fieldset>
            <legend>学生</legend>
            <p>	
            ...
            <p>
                ...
                <form:select path="classes.id">
                     <form:option value="${student.classid}" >${student.classes.name}</form:option>
                     <form:options items="${clalist}" itemLabel="name" itemValue="id"></form:options>
                </form:select>
            ...
            <p>
                ...
                <form:input path="login.loginname" size="50"/>
                <form:errors path="login.loginname" cssClass="error"></form:errors>
            </p>
            <p>
                <label for="login.password">密码：</label>
                <form:input path="login.password" size="50"/>
                <form:errors path="login.password" cssClass="error"></form:errors>
            </p>
            <p>
                <form:hidden path="login.id" size="50"/>
            </p> 
            <p>
