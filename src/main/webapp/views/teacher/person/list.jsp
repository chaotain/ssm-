    ...
    <div class="main">
        <h2 class="title"><span>个人信息</span></h2>
         <table class="table">
		        ...
		        <tr>
			        <th>类　别：</th>
			        <td><label class="label label-info" >${teacher.teatype.type}</label></td>
		        </tr>
		        <tr>
			        <th>工　号：</th>
		        ...
		        <tr>
			        <th>登录名：</th>
			        <td><label class="label label-info">${teacher.login.loginname }</label></td>
		        </tr>
		        <tr>
		           <th>密　码：</th>
			       <td>
			           ...
			           <input type="hidden" name="loginname" value="${teacher.login.loginname }">
			           <input type="text" name="password" value="${teacher.login.password}" placeholder="请输入密码">
