        ...
        <form:form action="${pageContext.request.contextPath }/cou/editSavect" modelAttribute="course">
            ...
            <p>
                ...
                <form:select path="tid">
                     ...
                     <form:options items="${tealist}"  itemLabel="name" itemValue="id"/>
                </form:select>
                <form:errors path="tid" cssClass="error"></form:errors>
            </p>
            
             <p>
                <label for="claids">选择班级：</label>
                <form:checkboxes path="claids" items="${clalist}"  itemLabel="name"  itemValue="id" delimiter="  " />
                <form:errors path="claids" cssClass="error"></form:errors>
            </p>
            	<form:hidden path="id" />
